...
- [ ] 2. Create `backend/utils/passwords.js` and its tests
...
- [ ] 3. Create `backend/utils/tokens.js` and its tests
...
- [ ] 4. Add `users` and `user_shops` to `initDB.js`
...
- [ ] 5. Seed the first super admin in `initDB.js`
...
- [ ] 6. Create `backend/middleware/auth.js`
...
- [ ] 7. Create `backend/middleware/shopScope.js`
...
- [ ] 9. Create `backend/controllers/authController.js`
...
- [ ] 10. Create `backend/routes/auth.js`
...
- [ ] 11. Mount the auth router and warn about legacy mode
