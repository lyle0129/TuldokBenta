...
- [ ] 1. Add the active-shop key to storage
...
- [ ] 2. Extend `src/utils/session.js` with active-shop state
...
- [ ] 3. Rewrite `queryKeys` in `src/queryClient.js`
...
- [ ] 4. Add `__tests__/queryKeys.test.js`
...
- [ ] 5. Thread `shopId` through every hook
...
- [ ] 6. Create `src/hooks/useActiveShop.js`
...
- [ ] 7. Add the super admin's shop list
...
- [ ] 8. Attach `X-Shop-Id` in `src/api.js`
...
- [ ] 9. Create `src/pages/SelectShop.jsx`
...
- [ ] 10. Create `ShopPicker.jsx` and render it
...
- [ ] 11. Gate the app on having a shop
